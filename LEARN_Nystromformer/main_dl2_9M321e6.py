...
def load_callbacks(n_iter, n_view, noise):
    ...
    Mycallbacks = []
    # Make output path
    output_path = "/home/thanhld/CT_Reconstruction/LEARN_Nystromformer/saved_results_noise_2_dl/results_LEARN_" + str(n_iter) + "_iters_bs_1_view_" + str(n_view) + "_noise_" + str(noise) + "_transform_2_9M/"
...
checkpoint_path = "/home/thanhld/CT_Reconstruction/LEARN_Nystromformer/saved_results_noise_2_dl/results_LEARN_14_iters_bs_1_view_32_noise_1000000.0_transform_2_9M/epoch=35-val_psnr=39.3679.ckpt"
