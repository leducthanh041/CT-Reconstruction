...
model = LEARN_pl.load_from_checkpoint("/mmlab_students/storageStudents/nguyenvd/Thanhld/CT-Reconstruction/LEARN/saved_results_noise_2/results_LEARN_30_iters_bs_1_view_64_noise_10000.0_transform/epoch=45-val_psnr=36.5145.ckpt")
...
trainer = pl.Trainer(accelerator='gpu',devices=[2],max_epochs=10,enable_checkpointing=True)
