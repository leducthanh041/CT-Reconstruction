...
def main():
    ...
    checkpoint_path = "/mmlab_students/storageStudents/nguyenvd/Thanhld/CT-Reconstruction/LEARN_LongNet/saved_results_noise_2_with_r2/results_LEARN_14_iters_bs_1_view_64_noise_0_transform/epoch=05-val_psnr=30.7393.ckpt"
    resume=True
