...
def main():
    ...
    checkpoint_path = "/mmlab_students/storageStudents/nguyenvd/Thanhld/CT-Reconstruction/LEARN_LongNet/saved_results_noise_2_with_r8/results_LEARN_14_iters_bs_1_view_64_noise_0_transform/epoch=02-val_psnr=19.7561.ckpt"
    resume=True
