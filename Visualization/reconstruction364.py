...
from CTSlice_Provider64 import CTSlice_Provider
...
model_learn = LEARN_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN/saved_results_noise_2/results_LEARN_30_iters_bs_1_view_64_noise_0_transform/epoch=45-val_psnr=47.4826.ckpt",
    map_location=device)
model_learn.eval().to(device)

model_longnet = LEARN_LongNet_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN_LongNet/saved_results_noise_2_with_LongNet/results_LEARN_14_iters_bs_1_view_64_noise_0_transform/epoch=45-val_psnr=44.6984.ckpt",
    map_location=device)
model_longnet.eval().to(device)

model_long = LEARN_Longformer_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN_Longformer/saved_results_noise_2_with_Longformer/results_LEARN_14_iters_bs_1_view_64_noise_0_transform/epoch=49-val_psnr=42.5714.ckpt",
    map_location=device)
model_long.eval().to(device)

model_nys = LEARN_Nys_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN_Nystromformer/saved_results_noise_2_with_Nystromformer/results_LEARN_14_iters_bs_1_view_64_noise_0_transform/epoch=45-val_psnr=46.7756.ckpt",
    map_location=device)
model_nys.eval().to(device)

model_reg = RegFormer_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/RegFormer/saved_results_noise_2/results_RegFormer_10_iters_bs_1_view_64_noise_0_transform/epoch=45-val_psnr=47.1590.ckpt",
    map_location=device)
...
model_learn = LEARN_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN/saved_results_noise_2/results_LEARN_30_iters_bs_1_view_64_noise_500000.0_transform/epoch=45-val_psnr=43.6203.ckpt",
    map_location=device)
model_learn.eval().to(device)

model_longnet = LEARN_LongNet_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN_LongNet/saved_results_noise_2_with_LongNet/results_LEARN_14_iters_bs_1_view_64_noise_500000.0_transform/epoch=45-val_psnr=42.6632.ckpt",
    map_location=device)
model_longnet.eval().to(device)

model_long = LEARN_Longformer_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN_Longformer/saved_results_noise_2_with_Longformer/results_LEARN_14_iters_bs_1_view_64_noise_500000.0_transform/epoch=45-val_psnr=41.0577.ckpt",
    map_location=device)
model_long.eval().to(device)

model_nys = LEARN_Nys_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN_Nystromformer/saved_results_noise_2_with_Nystromformer/results_LEARN_14_iters_bs_1_view_64_noise_500000.0_transform/epoch=15-val_psnr=43.5216.ckpt",
    map_location=device)
model_nys.eval().to(device)


model_reg = RegFormer_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/RegFormer/saved_results_noise_2/results_RegFormer_10_iters_bs_1_view_64_noise_500000.0_transform/epoch=45-val_psnr=43.8952.ckpt",
    map_location=device)
model_reg.eval().to(device)
...
model_learn = LEARN_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN/saved_results_noise_2/results_LEARN_30_iters_bs_1_view_64_noise_1000000.0_transform/epoch=45-val_psnr=44.5848.ckpt",
    map_location=device)
model_learn.eval().to(device)

model_longnet = LEARN_LongNet_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN_LongNet/saved_results_noise_2_with_LongNet/results_LEARN_14_iters_bs_1_view_64_noise_1000000.0_transform/epoch=45-val_psnr=43.4135.ckpt",
    map_location=device)
model_longnet.eval().to(device)

model_long = LEARN_Longformer_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN_Longformer/saved_results_noise_2_with_Longformer/results_LEARN_14_iters_bs_1_view_64_noise_1000000.0_transform/epoch=46-val_psnr=40.9645.ckpt",
    map_location=device)
model_long.eval().to(device)

model_nys = LEARN_Nys_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/LEARN_Nystromformer/saved_results_noise_2_with_Nystromformer/results_LEARN_14_iters_bs_1_view_64_noise_1000000.0_transform/epoch=45-val_psnr=44.2874.ckpt",
    map_location=device)
model_nys.eval().to(device)


model_reg = RegFormer_pl.load_from_checkpoint(
    "/data/uittogether/Thanhld/CT-Reconstruction/RegFormer/saved_results_noise_2/results_RegFormer_10_iters_bs_1_view_64_noise_1000000.0_transform/epoch=45-val_psnr=44.7691.ckpt",
    map_location=device)
model_reg.eval().to(device)
