...
checkpoint_path = "/home/thanhld/CT_Reconstruction/RegFormer/saved_results_noise_2_dl/results_RegFormer_10_iters_bs_1_view_64_noise_1000000.0_transform/epoch=45-val_psnr=44.1388.ckpt"

# Tải mô hình từ checkpoint và truyền vào các toán tử Radon và FBP
model = RegFormer_pl.load_from_checkpoint(checkpoint_path)
