...
def load_callbacks(n_iter, n_view, noise):
    ...
    Mycallbacks = []
    # Make output path
    output_path = "/home/thanhld/CT_Reconstruction/RegFormer/saved_results_noise_2_dl/results_RegFormer_" + str(n_iter) + "_iters_bs_1_view_" + str(n_view) + "_noise_" + str(noise) + "_transform_difflr/"
...
checkpoint_path = "/home/thanhld/CT_Reconstruction/RegFormer/saved_results_noise_2_dl/results_RegFormer_10_iters_bs_1_view_32_noise_1000000.0_transform/epoch=06-val_psnr=28.8845.ckpt"

# Nếu checkpoint tồn tại, hãy tải mô hình từ checkpoint
if os.path.exists(checkpoint_path):
    print(f"Loading model from checkpoint: {checkpoint_path}")
    model = RegFormer_pl.load_from_checkpoint(checkpoint_path)  # Tải mô hình từ checkpoint
else:
    model = RegFormer_pl(
