...
def load_callbacks(n_iter, n_view, noise):
    ...
    Mycallbacks = []
    # Make output path
    output_path = "/mmlab_students/storageStudents/nguyenvd/Thanhld/CT-Reconstruction/LEARN_Longformer/saved_results_noise_8_with_Longformer/results_LEARN_" + str(n_iter) + "_iters_bs_1_view_" + str(n_view) + "_noise_" + str(noise) + "_transform/"
...
checkpoint_path = "/datastore/uittogether3/LuuTru/Thanhld/CT-Reconstruction/LEARN_Longformer/saved_results_noise_8_with_Longformer/results_LEARN_14_iters_bs_1_view_64_noise_0_transform/epoch=00-val_psnr=32.9969.ckpt"
resume = False
