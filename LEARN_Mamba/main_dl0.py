...
def load_callbacks(n_iter, n_view, noise):
    ...
    Mycallbacks = []
    # Make output path
    output_path = "/data/uittogether/LuuTru/Thanhld/CT-Reconstruction/LEARN_Mamba/saved_results_noise_2_dl/results_LEARN_" + str(n_iter) + "_iters_bs_1_view_" + str(n_view) + "_noise_" + str(noise) + "_transform/"
...
checkpoint_path = "/home/thanhld/CT_Reconstruction/LEARN_Longformer/saved_results_noise_2_dl_with_Longformer/results_LEARN_14_iters_bs_1_view_64_noise_0_transform/epoch=00-val_psnr=32.99.ckpt"
