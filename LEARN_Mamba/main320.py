...
def load_callbacks(n_iter, n_view, noise):
    ...
    Mycallbacks = []
    # Make output path
    output_path = "/home/uit2023/LuuTru/Thanhld/CT_Reconstruction2/LEARN_Longformer/saved_results_noise_2_with_Longformer/results_LEARN_" + str(n_iter) + "_iters_bs_1_view_" + str(n_view) + "_noise_" + str(noise) + "_transform/"
